...
class DisposableFmSpider(scrapy.Spider):
    name = 'Disposable_fm'
    allowed_domains = ['amazon.com']
    # Base URL for the MacBook air reviews
    myBaseUrl = "https://www.amazon.com/Disposable-Face-Masks-Breathable-Comfortable/product-reviews/B084TQKLCC/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber="
    start_urls=[]
