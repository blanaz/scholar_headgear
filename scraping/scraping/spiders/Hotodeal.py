...
class HotodealSpider(scrapy.Spider):
    name = 'Hotodeal'
    allowed_domains = ['amazon.com']
    # Base URL for the MacBook air reviews
    myBaseUrl = "https://www.amazon.com/Hotodeal-Disposable-Breathable-Protection-Lightweight/product-reviews/B086HMXMH9/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber="
    start_urls=[]
