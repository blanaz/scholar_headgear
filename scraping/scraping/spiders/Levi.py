...
class LeviSpider(scrapy.Spider):
    ...
    myBaseUrl = "https://www.amazon.com/Levis-Re-Usable-Bandana-Print-Reversible/product-reviews/B08KXNVK33/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber="
    start_urls=[]
