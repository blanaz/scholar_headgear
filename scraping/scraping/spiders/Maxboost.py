...
class MaxboostSpider(scrapy.Spider):
    name = 'Maxboost'
    allowed_domains = ['amazon.com']
    # Base URL for the MacBook air reviews
    myBaseUrl = "https://www.amazon.com/Maxboost-Protective-Face-Shield-Transparent/product-reviews/B089QYYZFY/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber="
    start_urls=[]
