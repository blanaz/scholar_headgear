...
class HanesSpider(scrapy.Spider):
    name = 'Hanes'
    allowed_domains = ['amazon.com']
    # Base URL for the MacBook air reviews
    myBaseUrl = "https://www.amazon.com/Reusable-Cotton-Face-Mask-Pack/product-reviews/B086WC1LDD/ref=cm_cr_arp_d_paging_btm_next_2?ie=UTF8&reviewerType=all_reviews&pageNumber="
    start_urls=[]
